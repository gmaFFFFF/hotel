...
public class TestContext : IDisposable {
    ...
    protected readonly IRepositoryFactory<IHotelBlocksRepository<int, Guid>, HotelBlock<int, Guid>, int>
        HotelRepoFactory;

    protected readonly ITestOutputHelper Output;
    protected readonly IPersonsRepository<Guid> PersonRepo;
    protected readonly IRepositoryFactory<IPersonsRepository<Guid>, Person<Guid>, Guid> PersonRepoFactory;
    ...
    public TestContext(ITestOutputHelper output) {
        ...
        PersonRepoFactory = FakeServiceProvider.Instance
            .GetRequiredService<IRepositoryFactory<IPersonsRepository<Guid>, Person<Guid>, Guid>>();
