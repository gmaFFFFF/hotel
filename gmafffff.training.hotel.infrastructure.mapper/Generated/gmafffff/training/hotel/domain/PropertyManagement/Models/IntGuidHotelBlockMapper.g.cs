...
namespace gmafffff.training.hotel.domain.PropertyManagement.Models
{
    ...
    {
        public static Expression<Func<HotelBlock<int, Guid>, HotelDto>> ProjectToHotelDto => p1 => new HotelDto(p1.Id, p1.Rooms.Select<Room<Guid>, RoomDto>(p2 => new RoomDto(p2.Id, p2.RoomDetails.Number, p2.RoomDetails.Type, p2.RoomDetails.Capacity) {RoomId = p2.Id}).ToList<RoomDto>())
        {
            BlockId = p1.Id,
